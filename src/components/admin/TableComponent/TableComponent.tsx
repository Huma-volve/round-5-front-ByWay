      ...
      <Table>
        ...
        <TableHeader>
          <TableRow className="bg-secondary-background">
            ...
            <TableHead className="font-semibold">
              {t("instructor.courseManagement.category")}
            </TableHead>
            <TableHead className="font-semibold">
              {t("instructor.courseManagement.selectStatus")}
            </TableHead>
            <TableHead className="font-semibold">
              {t("instructor.courseManagement.createdDate")}
            </TableHead>
                    ...
                    <DropdownMenuContent>
                      ...
                      <DropdownMenuItem>
                        <button
                          ...
                          className="p-0 h-auto text-green-600 disabled:opacity-50"
                        >
